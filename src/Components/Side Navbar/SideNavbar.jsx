    ...
    <div ref={mainNav} className="bg-dark-blue h-fit hidden lg:block lg:h-full">
      <div className="py-2 bg-light-pink flex items-center justify-center">
        <div className="w-20 object-center h-20 rounded-full overflow-hidden">
          {/* <img src="https://images.unsplash.com/photo-1630091003936-aea522c1e8c3?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" className=" object-cover w-full h-full object-bottom" /> */}
          <img
            src="/hero.jpg"
            alt=""
